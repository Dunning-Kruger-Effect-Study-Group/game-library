...
export const PlatformCard: FC<{ platformData: IPlatform }> = ({
  platformData,
}) => {
  return (
    <figure className="flex flex-col m-2 border-[3px] box-border border-Baby_Blue items-center bg-Midnight_Blue text-Baby_Blue">
